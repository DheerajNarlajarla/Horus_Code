# PowerShell script to build a portable version of Horus Code
Write-Host "Building portable version of Horus Code..." -ForegroundColor Green
Write-Host "This script will download VSCodium and apply the custom themes" -ForegroundColor Yellow
...
// @namespace      HorusCode
// @version        1.0
// @description    Loads custom themes for Horus Code
// @match          *
// @grant          none
// ==/UserScript==
...
1. Copy this entire folder to any location (USB drive, local disk, etc.)
2. Run one of the batch files to start the application
...
"@
    ...
    Write-Host ""
    Write-Host "To use Horus Code:" -ForegroundColor Yellow
